...
const missionImage = "https://images.unsplash.com/photo-1522071820081-009f0129c71c?ixlib=rb-4.0.3&auto=format&fit=crop&w=2070&q=80";
            ...
            <div className="flex justify-start mb-4 overflow-x-auto pb-2">
              <div className="flex space-x-3">
                {['👨‍💻', '👩‍🎨', '🧑‍💼', '👨‍🔧', '👩‍💻'].map((emoji, i) => (
                  <div 
                    key={i}
                    className="w-10 h-10 bg-white rounded-full border-2 border-orange-400 flex items-center justify-center hover:scale-110 transition-transform duration-200 shadow-sm"
                  >
